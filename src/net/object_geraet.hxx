...
protected:
  ...
  /**
   * This function is provided for compatibility with automatically generated
   * code, which may call it when updating the remote mirror.
   * @param error if true, aborts the program, as the autogenerated code has
   * violated its own protocol; if false, the function does nothing.
   */
  void destroy(bool error) const throw() { assert(!error); }
};
