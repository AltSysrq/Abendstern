...
/* This file must be included ONLY by the file autogenerated
 * by generate.tcl (bridge.cxx). It implements common code
 * shared by all things autogenerated.
 */

#ifndef BRIDGE_CXX_
#error implementation.hxx must not be included outside of bridge.cxx
#endif
...
namespace tcl_glue_implementation {
   ...
   * as a set of things it can be cast to.
   */
  struct TypeExport {
    bool isAObject;
    const type_info& theType;
    set<const type_info*> superclasses;
    string tclClassName;

    TypeExport(const type_info& t) : theType(t) {}
  };
  ...
  #define typeExports (*typeExports_ptr)
  ...
  struct InterpInfo {
     ...
     * a pointer.
     */
    map<void*, Export*> exports;
    /* Similar, but map from Tcl names to Exports.
     */
    map<string, Export*> exportsByName;
  ...
  class Interpreters: public map<Tcl_Interp*, InterpInfo*> {
    public:
    bool destroyed;
  ...
  #define interpreters (*interpreters_ptr)
