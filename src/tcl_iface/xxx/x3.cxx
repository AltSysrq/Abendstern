...
static int set90 (ClientData, Tcl_Interp* interp, int objc, Tcl_Obj*const objv[]) throw() {
      ...
      //Extract value
      {
        ...
        if (strlen(tmp) > 100) { scriptError("Enumeration value too long"); }
          ...
          if (0 == strcmp(tmp, "k_unknown")) {newVal=SDLK_UNKNOWN; goto done1507;}
        
          if (0 == strcmp(tmp, "k_enter")) {newVal=SDLK_RETURN; goto done1507;}
        
          if (0 == strcmp(tmp, "k_scrolllock")) {newVal=SDLK_SCROLLOCK; goto done1507;}
        
          if (0 == strcmp(tmp, "k_backspace")) {newVal=SDLK_BACKSPACE; goto done1507;}
        
          if (0 == strcmp(tmp, "k_tab")) {newVal=SDLK_TAB; goto done1507;}
        
          if (0 == strcmp(tmp, "k_clear")) {newVal=SDLK_CLEAR; goto done1507;}
        
          if (0 == strcmp(tmp, "k_pause")) {newVal=SDLK_PAUSE; goto done1507;}
        
          if (0 == strcmp(tmp, "k_escape")) {newVal=SDLK_ESCAPE; goto done1507;}
        
          if (0 == strcmp(tmp, "k_space")) {newVal=SDLK_SPACE; goto done1507;}
        
          if (0 == strcmp(tmp, "k_exclaim")) {newVal=SDLK_EXCLAIM; goto done1507;}
        
          if (0 == strcmp(tmp, "k_quotedbl")) {newVal=SDLK_QUOTEDBL; goto done1507;}
        
          if (0 == strcmp(tmp, "k_hash")) {newVal=SDLK_HASH; goto done1507;}
        
          if (0 == strcmp(tmp, "k_dollar")) {newVal=SDLK_DOLLAR; goto done1507;}
        
          if (0 == strcmp(tmp, "k_ampersand")) {newVal=SDLK_AMPERSAND; goto done1507;}
        
          if (0 == strcmp(tmp, "k_quote")) {newVal=SDLK_QUOTE; goto done1507;}
        
          if (0 == strcmp(tmp, "k_leftparen")) {newVal=SDLK_LEFTPAREN; goto done1507;}
        
          if (0 == strcmp(tmp, "k_rightparen")) {newVal=SDLK_RIGHTPAREN; goto done1507;}
        
          if (0 == strcmp(tmp, "k_asterisk")) {newVal=SDLK_ASTERISK; goto done1507;}
        
          if (0 == strcmp(tmp, "k_plus")) {newVal=SDLK_PLUS; goto done1507;}
        
          if (0 == strcmp(tmp, "k_comma")) {newVal=SDLK_COMMA; goto done1507;}
        
          if (0 == strcmp(tmp, "k_minus")) {newVal=SDLK_MINUS; goto done1507;}
        
          if (0 == strcmp(tmp, "k_period")) {newVal=SDLK_PERIOD; goto done1507;}
        
          if (0 == strcmp(tmp, "k_slash")) {newVal=SDLK_SLASH; goto done1507;}
        
          if (0 == strcmp(tmp, "k_0")) {newVal=SDLK_0; goto done1507;}
        
          if (0 == strcmp(tmp, "k_1")) {newVal=SDLK_1; goto done1507;}
        
          if (0 == strcmp(tmp, "k_2")) {newVal=SDLK_2; goto done1507;}
        
          if (0 == strcmp(tmp, "k_3")) {newVal=SDLK_3; goto done1507;}
        
          if (0 == strcmp(tmp, "k_4")) {newVal=SDLK_4; goto done1507;}
        
          if (0 == strcmp(tmp, "k_5")) {newVal=SDLK_5; goto done1507;}
        
          if (0 == strcmp(tmp, "k_6")) {newVal=SDLK_6; goto done1507;}
        
          if (0 == strcmp(tmp, "k_7")) {newVal=SDLK_7; goto done1507;}
        
          if (0 == strcmp(tmp, "k_8")) {newVal=SDLK_8; goto done1507;}
        
          if (0 == strcmp(tmp, "k_9")) {newVal=SDLK_9; goto done1507;}
        
          if (0 == strcmp(tmp, "k_colon")) {newVal=SDLK_COLON; goto done1507;}
        
          if (0 == strcmp(tmp, "k_semicolon")) {newVal=SDLK_SEMICOLON; goto done1507;}
        
          if (0 == strcmp(tmp, "k_less")) {newVal=SDLK_LESS; goto done1507;}
        
          if (0 == strcmp(tmp, "k_equals")) {newVal=SDLK_EQUALS; goto done1507;}
        
          if (0 == strcmp(tmp, "k_greater")) {newVal=SDLK_GREATER; goto done1507;}
        
          if (0 == strcmp(tmp, "k_question")) {newVal=SDLK_QUESTION; goto done1507;}
        
          if (0 == strcmp(tmp, "k_at")) {newVal=SDLK_AT; goto done1507;}
        
          if (0 == strcmp(tmp, "k_leftbracket")) {newVal=SDLK_LEFTBRACKET; goto done1507;}
        
          if (0 == strcmp(tmp, "k_backslash")) {newVal=SDLK_BACKSLASH; goto done1507;}
        
          if (0 == strcmp(tmp, "k_rightbracket")) {newVal=SDLK_RIGHTBRACKET; goto done1507;}
        
          if (0 == strcmp(tmp, "k_caret")) {newVal=SDLK_CARET; goto done1507;}
        
          if (0 == strcmp(tmp, "k_underscore")) {newVal=SDLK_UNDERSCORE; goto done1507;}
        
          if (0 == strcmp(tmp, "k_backquote")) {newVal=SDLK_BACKQUOTE; goto done1507;}
        
          if (0 == strcmp(tmp, "k_delete")) {newVal=SDLK_DELETE; goto done1507;}
        
          if (0 == strcmp(tmp, "k_kp0")) {newVal=SDLK_KP0; goto done1507;}
        
          if (0 == strcmp(tmp, "k_kp1")) {newVal=SDLK_KP1; goto done1507;}
        
          if (0 == strcmp(tmp, "k_kp2")) {newVal=SDLK_KP2; goto done1507;}
        
          if (0 == strcmp(tmp, "k_kp3")) {newVal=SDLK_KP3; goto done1507;}
        
          if (0 == strcmp(tmp, "k_kp4")) {newVal=SDLK_KP4; goto done1507;}
        
          if (0 == strcmp(tmp, "k_kp5")) {newVal=SDLK_KP5; goto done1507;}
        
          if (0 == strcmp(tmp, "k_kp6")) {newVal=SDLK_KP6; goto done1507;}
        
          if (0 == strcmp(tmp, "k_kp7")) {newVal=SDLK_KP7; goto done1507;}
        
          if (0 == strcmp(tmp, "k_kp8")) {newVal=SDLK_KP8; goto done1507;}
        
          if (0 == strcmp(tmp, "k_kp9")) {newVal=SDLK_KP9; goto done1507;}
        
          if (0 == strcmp(tmp, "k_kp_period")) {newVal=SDLK_KP_PERIOD; goto done1507;}
        
          if (0 == strcmp(tmp, "k_kp_divide")) {newVal=SDLK_KP_DIVIDE; goto done1507;}
        
          if (0 == strcmp(tmp, "k_kp_multiply")) {newVal=SDLK_KP_MULTIPLY; goto done1507;}
        
          if (0 == strcmp(tmp, "k_kp_minus")) {newVal=SDLK_KP_MINUS; goto done1507;}
        
          if (0 == strcmp(tmp, "k_kp_plus")) {newVal=SDLK_KP_PLUS; goto done1507;}
        
          if (0 == strcmp(tmp, "k_kp_enter")) {newVal=SDLK_KP_ENTER; goto done1507;}
        
          if (0 == strcmp(tmp, "k_kp_equals")) {newVal=SDLK_KP_EQUALS; goto done1507;}
        
          if (0 == strcmp(tmp, "k_up")) {newVal=SDLK_UP; goto done1507;}
        
          if (0 == strcmp(tmp, "k_down")) {newVal=SDLK_DOWN; goto done1507;}
        
          if (0 == strcmp(tmp, "k_right")) {newVal=SDLK_RIGHT; goto done1507;}
        
          if (0 == strcmp(tmp, "k_left")) {newVal=SDLK_LEFT; goto done1507;}
        
          if (0 == strcmp(tmp, "k_insert")) {newVal=SDLK_INSERT; goto done1507;}
        
          if (0 == strcmp(tmp, "k_home")) {newVal=SDLK_HOME; goto done1507;}
        
          if (0 == strcmp(tmp, "k_end")) {newVal=SDLK_END; goto done1507;}
        
          if (0 == strcmp(tmp, "k_pageup")) {newVal=SDLK_PAGEUP; goto done1507;}
        
          if (0 == strcmp(tmp, "k_pagedown")) {newVal=SDLK_PAGEDOWN; goto done1507;}
        
          if (0 == strcmp(tmp, "k_f1")) {newVal=SDLK_F1; goto done1507;}
        
          if (0 == strcmp(tmp, "k_f2")) {newVal=SDLK_F2; goto done1507;}
        
          if (0 == strcmp(tmp, "k_f3")) {newVal=SDLK_F3; goto done1507;}
        
          if (0 == strcmp(tmp, "k_f4")) {newVal=SDLK_F4; goto done1507;}
        
          if (0 == strcmp(tmp, "k_f5")) {newVal=SDLK_F5; goto done1507;}
        
          if (0 == strcmp(tmp, "k_f6")) {newVal=SDLK_F6; goto done1507;}
        
          if (0 == strcmp(tmp, "k_f7")) {newVal=SDLK_F7; goto done1507;}
        
          if (0 == strcmp(tmp, "k_f8")) {newVal=SDLK_F8; goto done1507;}
        
          if (0 == strcmp(tmp, "k_f9")) {newVal=SDLK_F9; goto done1507;}
        
          if (0 == strcmp(tmp, "k_f10")) {newVal=SDLK_F10; goto done1507;}
        
          if (0 == strcmp(tmp, "k_f11")) {newVal=SDLK_F11; goto done1507;}
        
          if (0 == strcmp(tmp, "k_f12")) {newVal=SDLK_F12; goto done1507;}
        
          if (0 == strcmp(tmp, "k_f13")) {newVal=SDLK_F13; goto done1507;}
        
          if (0 == strcmp(tmp, "k_f14")) {newVal=SDLK_F14; goto done1507;}
        
          if (0 == strcmp(tmp, "k_f15")) {newVal=SDLK_F15; goto done1507;}
        
          if (0 == strcmp(tmp, "k_numlock")) {newVal=SDLK_NUMLOCK; goto done1507;}
        
          if (0 == strcmp(tmp, "k_capslock")) {newVal=SDLK_CAPSLOCK; goto done1507;}
        
          if (0 == strcmp(tmp, "k_rshift")) {newVal=SDLK_RSHIFT; goto done1507;}
        
          if (0 == strcmp(tmp, "k_lshift")) {newVal=SDLK_LSHIFT; goto done1507;}
        
          if (0 == strcmp(tmp, "k_rctrl")) {newVal=SDLK_RCTRL; goto done1507;}
        
          if (0 == strcmp(tmp, "k_lctrl")) {newVal=SDLK_LCTRL; goto done1507;}
        
          if (0 == strcmp(tmp, "k_ralt")) {newVal=SDLK_RALT; goto done1507;}
        
          if (0 == strcmp(tmp, "k_lalt")) {newVal=SDLK_LALT; goto done1507;}
        
          if (0 == strcmp(tmp, "k_rmeta")) {newVal=SDLK_RMETA; goto done1507;}
        
          if (0 == strcmp(tmp, "k_lmeta")) {newVal=SDLK_LMETA; goto done1507;}
        
          if (0 == strcmp(tmp, "k_lsuper")) {newVal=SDLK_LSUPER; goto done1507;}
        
          if (0 == strcmp(tmp, "k_rsuper")) {newVal=SDLK_RSUPER; goto done1507;}
        
          if (0 == strcmp(tmp, "k_mode")) {newVal=SDLK_MODE; goto done1507;}
        
          if (0 == strcmp(tmp, "k_compose")) {newVal=SDLK_COMPOSE; goto done1507;}
        
          if (0 == strcmp(tmp, "k_help")) {newVal=SDLK_HELP; goto done1507;}
        
          if (0 == strcmp(tmp, "k_print")) {newVal=SDLK_PRINT; goto done1507;}
        
          if (0 == strcmp(tmp, "k_sysreq")) {newVal=SDLK_SYSREQ; goto done1507;}
        
          if (0 == strcmp(tmp, "k_break")) {newVal=SDLK_BREAK; goto done1507;}
        
          if (0 == strcmp(tmp, "k_menu")) {newVal=SDLK_MENU; goto done1507;}
        
          if (0 == strcmp(tmp, "k_power")) {newVal=SDLK_POWER; goto done1507;}
        
          if (0 == strcmp(tmp, "k_euro")) {newVal=SDLK_EURO; goto done1507;}
        
          if (0 == strcmp(tmp, "k_undo")) {newVal=SDLK_UNDO; goto done1507;}
        
          if (0 == strcmp(tmp, "k_a")) {newVal=SDLK_a; goto done1507;}
        
          if (0 == strcmp(tmp, "k_b")) {newVal=SDLK_b; goto done1507;}
        
          if (0 == strcmp(tmp, "k_c")) {newVal=SDLK_c; goto done1507;}
        
          if (0 == strcmp(tmp, "k_d")) {newVal=SDLK_d; goto done1507;}
        
          if (0 == strcmp(tmp, "k_e")) {newVal=SDLK_e; goto done1507;}
        
          if (0 == strcmp(tmp, "k_f")) {newVal=SDLK_f; goto done1507;}
        
          if (0 == strcmp(tmp, "k_g")) {newVal=SDLK_g; goto done1507;}
        
          if (0 == strcmp(tmp, "k_h")) {newVal=SDLK_h; goto done1507;}
        
          if (0 == strcmp(tmp, "k_i")) {newVal=SDLK_i; goto done1507;}
        
          if (0 == strcmp(tmp, "k_j")) {newVal=SDLK_j; goto done1507;}
        
          if (0 == strcmp(tmp, "k_k")) {newVal=SDLK_k; goto done1507;}
        
          if (0 == strcmp(tmp, "k_l")) {newVal=SDLK_l; goto done1507;}
        
          if (0 == strcmp(tmp, "k_m")) {newVal=SDLK_m; goto done1507;}
        
          if (0 == strcmp(tmp, "k_n")) {newVal=SDLK_n; goto done1507;}
        
          if (0 == strcmp(tmp, "k_o")) {newVal=SDLK_o; goto done1507;}
        
          if (0 == strcmp(tmp, "k_p")) {newVal=SDLK_p; goto done1507;}
        
          if (0 == strcmp(tmp, "k_q")) {newVal=SDLK_q; goto done1507;}
        
          if (0 == strcmp(tmp, "k_r")) {newVal=SDLK_r; goto done1507;}
        
          if (0 == strcmp(tmp, "k_s")) {newVal=SDLK_s; goto done1507;}
        
          if (0 == strcmp(tmp, "k_t")) {newVal=SDLK_t; goto done1507;}
        
          if (0 == strcmp(tmp, "k_u")) {newVal=SDLK_u; goto done1507;}
        
          if (0 == strcmp(tmp, "k_v")) {newVal=SDLK_v; goto done1507;}
        
          if (0 == strcmp(tmp, "k_w")) {newVal=SDLK_w; goto done1507;}
        
          if (0 == strcmp(tmp, "k_x")) {newVal=SDLK_x; goto done1507;}
        
          if (0 == strcmp(tmp, "k_y")) {newVal=SDLK_y; goto done1507;}
        
          if (0 == strcmp(tmp, "k_z")) {newVal=SDLK_z; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_0")) {newVal=SDLK_WORLD_0; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_1")) {newVal=SDLK_WORLD_1; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_2")) {newVal=SDLK_WORLD_2; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_3")) {newVal=SDLK_WORLD_3; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_4")) {newVal=SDLK_WORLD_4; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_5")) {newVal=SDLK_WORLD_5; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_6")) {newVal=SDLK_WORLD_6; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_7")) {newVal=SDLK_WORLD_7; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_8")) {newVal=SDLK_WORLD_8; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_9")) {newVal=SDLK_WORLD_9; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_10")) {newVal=SDLK_WORLD_10; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_11")) {newVal=SDLK_WORLD_11; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_12")) {newVal=SDLK_WORLD_12; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_13")) {newVal=SDLK_WORLD_13; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_14")) {newVal=SDLK_WORLD_14; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_15")) {newVal=SDLK_WORLD_15; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_16")) {newVal=SDLK_WORLD_16; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_17")) {newVal=SDLK_WORLD_17; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_18")) {newVal=SDLK_WORLD_18; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_19")) {newVal=SDLK_WORLD_19; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_20")) {newVal=SDLK_WORLD_20; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_21")) {newVal=SDLK_WORLD_21; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_22")) {newVal=SDLK_WORLD_22; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_23")) {newVal=SDLK_WORLD_23; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_24")) {newVal=SDLK_WORLD_24; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_25")) {newVal=SDLK_WORLD_25; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_26")) {newVal=SDLK_WORLD_26; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_27")) {newVal=SDLK_WORLD_27; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_28")) {newVal=SDLK_WORLD_28; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_29")) {newVal=SDLK_WORLD_29; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_30")) {newVal=SDLK_WORLD_30; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_31")) {newVal=SDLK_WORLD_31; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_32")) {newVal=SDLK_WORLD_32; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_33")) {newVal=SDLK_WORLD_33; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_34")) {newVal=SDLK_WORLD_34; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_35")) {newVal=SDLK_WORLD_35; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_36")) {newVal=SDLK_WORLD_36; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_37")) {newVal=SDLK_WORLD_37; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_38")) {newVal=SDLK_WORLD_38; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_39")) {newVal=SDLK_WORLD_39; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_40")) {newVal=SDLK_WORLD_40; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_41")) {newVal=SDLK_WORLD_41; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_42")) {newVal=SDLK_WORLD_42; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_43")) {newVal=SDLK_WORLD_43; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_44")) {newVal=SDLK_WORLD_44; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_45")) {newVal=SDLK_WORLD_45; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_46")) {newVal=SDLK_WORLD_46; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_47")) {newVal=SDLK_WORLD_47; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_48")) {newVal=SDLK_WORLD_48; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_49")) {newVal=SDLK_WORLD_49; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_50")) {newVal=SDLK_WORLD_50; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_51")) {newVal=SDLK_WORLD_51; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_52")) {newVal=SDLK_WORLD_52; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_53")) {newVal=SDLK_WORLD_53; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_54")) {newVal=SDLK_WORLD_54; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_55")) {newVal=SDLK_WORLD_55; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_56")) {newVal=SDLK_WORLD_56; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_57")) {newVal=SDLK_WORLD_57; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_58")) {newVal=SDLK_WORLD_58; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_59")) {newVal=SDLK_WORLD_59; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_60")) {newVal=SDLK_WORLD_60; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_61")) {newVal=SDLK_WORLD_61; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_62")) {newVal=SDLK_WORLD_62; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_63")) {newVal=SDLK_WORLD_63; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_64")) {newVal=SDLK_WORLD_64; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_65")) {newVal=SDLK_WORLD_65; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_66")) {newVal=SDLK_WORLD_66; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_67")) {newVal=SDLK_WORLD_67; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_68")) {newVal=SDLK_WORLD_68; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_69")) {newVal=SDLK_WORLD_69; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_70")) {newVal=SDLK_WORLD_70; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_71")) {newVal=SDLK_WORLD_71; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_72")) {newVal=SDLK_WORLD_72; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_73")) {newVal=SDLK_WORLD_73; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_74")) {newVal=SDLK_WORLD_74; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_75")) {newVal=SDLK_WORLD_75; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_76")) {newVal=SDLK_WORLD_76; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_77")) {newVal=SDLK_WORLD_77; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_78")) {newVal=SDLK_WORLD_78; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_79")) {newVal=SDLK_WORLD_79; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_80")) {newVal=SDLK_WORLD_80; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_81")) {newVal=SDLK_WORLD_81; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_82")) {newVal=SDLK_WORLD_82; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_83")) {newVal=SDLK_WORLD_83; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_84")) {newVal=SDLK_WORLD_84; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_85")) {newVal=SDLK_WORLD_85; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_86")) {newVal=SDLK_WORLD_86; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_87")) {newVal=SDLK_WORLD_87; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_88")) {newVal=SDLK_WORLD_88; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_89")) {newVal=SDLK_WORLD_89; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_90")) {newVal=SDLK_WORLD_90; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_91")) {newVal=SDLK_WORLD_91; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_92")) {newVal=SDLK_WORLD_92; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_93")) {newVal=SDLK_WORLD_93; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_94")) {newVal=SDLK_WORLD_94; goto done1507;}
        
          if (0 == strcmp(tmp, "k_world_95")) {newVal=SDLK_WORLD_95; goto done1507;}
         {
...
static int set100 (ClientData, Tcl_Interp* interp, int objc, Tcl_Obj*const objv[]) throw() {
      ...
      //Extract value
      {
        ...
        if (strlen(tmp) > 100) { scriptError("Enumeration value too long"); }
          ...
          if (0 == strcmp(tmp, "DOWN")) {newVal=SDL_KEYDOWN; goto done1511;}
        
          if (0 == strcmp(tmp, "UP")) {newVal=SDL_KEYUP; goto done1511;}
         {
...
static int set103 (ClientData, Tcl_Interp* interp, int objc, Tcl_Obj*const objv[]) throw() {
      ...
      //Extract value
      {
        ...
        if (strlen(tmp) > 100) { scriptError("Enumeration value too long"); }
          ...
          if (0 == strcmp(tmp, "PRESSED")) {newVal=SDL_PRESSED; goto done1513;}
        
          if (0 == strcmp(tmp, "RELEASED")) {newVal=SDL_RELEASED; goto done1513;}
         {
        sprintf(staticError, "Unable to convert %s to Uint8", tmp);
        scriptError(staticError);
      } 
...
static int set147 (ClientData, Tcl_Interp* interp, int objc, Tcl_Obj*const objv[]) throw() {
      ...
      //Extract value
      {
        ...
        if (strlen(tmp) > 100) { scriptError("Enumeration value too long"); }
          ...
          if (0 == strcmp(tmp, "DOWN")) {newVal=SDL_MOUSEBUTTONDOWN; goto done1523;}
        
          if (0 == strcmp(tmp, "UP")) {newVal=SDL_MOUSEBUTTONUP; goto done1523;}
         {
        sprintf(staticError, "Unable to convert %s to Uint8", tmp);
        scriptError(staticError);
      } 
...
static int set153 (ClientData, Tcl_Interp* interp, int objc, Tcl_Obj*const objv[]) throw() {
      ...
      //Extract value
      {
        ...
        if (strlen(tmp) > 100) { scriptError("Enumeration value too long"); }
          ...
          if (0 == strcmp(tmp, "mb_left")) {newVal=SDL_BUTTON_LEFT; goto done1526;}
        
          if (0 == strcmp(tmp, "mb_mid")) {newVal=SDL_BUTTON_MIDDLE; goto done1526;}
        
          if (0 == strcmp(tmp, "mb_right")) {newVal=SDL_BUTTON_RIGHT; goto done1526;}
        
          if (0 == strcmp(tmp, "mb_wup")) {newVal=SDL_BUTTON_WHEELUP; goto done1526;}
        
          if (0 == strcmp(tmp, "mb_wdown")) {newVal=SDL_BUTTON_WHEELDOWN; goto done1526;}
         {
        sprintf(staticError, "Unable to convert %s to Uint8", tmp);
        scriptError(staticError);
      } 
...
static int set156 (ClientData, Tcl_Interp* interp, int objc, Tcl_Obj*const objv[]) throw() {
      ...
      //Extract value
      {
        ...
        if (strlen(tmp) > 100) { scriptError("Enumeration value too long"); }
          ...
          if (0 == strcmp(tmp, "PRESSED")) {newVal=SDL_PRESSED; goto done1528;}
        
          if (0 == strcmp(tmp, "RELEASED")) {newVal=SDL_RELEASED; goto done1528;}
         {
        sprintf(staticError, "Unable to convert %s to Uint8", tmp);
        scriptError(staticError);
      } 
...
PUSH_TCL_ERROR_HANDLER(errorOccurred); if (errorOccurred) goto error;
{
      ...
      if (!parent) { scriptError("NULL this passed into C++"); }
{int gen1731;
            int err = Tcl_GetBooleanFromObj(interp, objv[1], (int*)&gen1731);
            arg0=gen1731;
            if (err == TCL_ERROR) {
              scriptError(Tcl_GetStringResult(interp));
            }};
...
PUSH_TCL_ERROR_HANDLER(errorOccurred); if (errorOccurred) goto error;
{
      ...
      if (!parent) { scriptError("NULL this passed into C++"); }
{int gen1734;
            int err = Tcl_GetBooleanFromObj(interp, objv[1], (int*)&gen1734);
            arg0=gen1734;
            if (err == TCL_ERROR) {
              scriptError(Tcl_GetStringResult(interp));
            }};
...
PUSH_TCL_ERROR_HANDLER(errorOccurred); if (errorOccurred) goto error;
{
      ...
      if (!parent) { scriptError("NULL this passed into C++"); }
{int gen1737;
            int err = Tcl_GetBooleanFromObj(interp, objv[1], (int*)&gen1737);
            arg0=gen1737;
            if (err == TCL_ERROR) {
              scriptError(Tcl_GetStringResult(interp));
            }};
...
PUSH_TCL_ERROR_HANDLER(errorOccurred); if (errorOccurred) goto error;
{
      ...
      if (!parent) { scriptError("NULL this passed into C++"); }
{int gen1740;
            int err = Tcl_GetBooleanFromObj(interp, objv[1], (int*)&gen1740);
            arg0=gen1740;
            if (err == TCL_ERROR) {
              scriptError(Tcl_GetStringResult(interp));
            }};
arg0Init=true;
{int gen1741;
            int err = Tcl_GetBooleanFromObj(interp, objv[2], (int*)&gen1741);
            arg1=gen1741;
            if (err == TCL_ERROR) {
              scriptError(Tcl_GetStringResult(interp));
            }};
      ...
      if (!parent) { scriptError("NULL this passed into C++"); }
{
        ...
        if (strlen(tmp) > 100) { scriptError("Enumeration value too long"); }
          ...
          if (0 == strcmp(tmp, "DCRMNone")) {arg0=DynamicCamera::None; goto done1871;}
        
          if (0 == strcmp(tmp, "DCRMDirection")) {arg0=DynamicCamera::Direction; goto done1871;}
        
          if (0 == strcmp(tmp, "DCRMVelocity")) {arg0=DynamicCamera::Velocity; goto done1871;}
         {
...
PUSH_TCL_ERROR_HANDLER(errorOccurred); if (errorOccurred) goto error;
{
      ...
      if (!parent) { scriptError("NULL this passed into C++"); }
{int gen2149;
            int err = Tcl_GetBooleanFromObj(interp, objv[1], (int*)&gen2149);
            arg0=gen2149;
            if (err == TCL_ERROR) {
              scriptError(Tcl_GetStringResult(interp));
            }};
...
arg0Init=true;
{int gen2157;
            int err = Tcl_GetBooleanFromObj(interp, objv[2], (int*)&gen2157);
            arg1=gen2157;
            if (err == TCL_ERROR) {
              scriptError(Tcl_GetStringResult(interp));
            }};
...
arg1Init=true;
{
        ...
        if (strlen(tmp) > 100) { scriptError("Enumeration value too long"); }
          ...
          if (0 == strcmp(tmp, "STInt")) {arg2=Setting::TypeInt; goto done2162;}
        
          if (0 == strcmp(tmp, "STInt64")) {arg2=Setting::TypeInt64; goto done2162;}
        
          if (0 == strcmp(tmp, "STFloat")) {arg2=Setting::TypeFloat; goto done2162;}
        
          if (0 == strcmp(tmp, "STBool")) {arg2=Setting::TypeBoolean; goto done2162;}
        
          if (0 == strcmp(tmp, "STString")) {arg2=Setting::TypeString; goto done2162;}
        
          if (0 == strcmp(tmp, "STArray")) {arg2=Setting::TypeArray; goto done2162;}
        
          if (0 == strcmp(tmp, "STList")) {arg2=Setting::TypeList; goto done2162;}
        
          if (0 == strcmp(tmp, "STGroup")) {arg2=Setting::TypeGroup; goto done2162;}
         {
...
arg1Init=true;
{int gen2164;
            int err = Tcl_GetBooleanFromObj(interp, objv[3], (int*)&gen2164);
            arg2=gen2164;
            if (err == TCL_ERROR) {
              scriptError(Tcl_GetStringResult(interp));
            }};
...
arg0Init=true;
{
        ...
        if (strlen(tmp) > 100) { scriptError("Enumeration value too long"); }
          ...
          if (0 == strcmp(tmp, "STInt")) {arg1=Setting::TypeInt; goto done2170;}
        
          if (0 == strcmp(tmp, "STInt64")) {arg1=Setting::TypeInt64; goto done2170;}
        
          if (0 == strcmp(tmp, "STFloat")) {arg1=Setting::TypeFloat; goto done2170;}
        
          if (0 == strcmp(tmp, "STBool")) {arg1=Setting::TypeBoolean; goto done2170;}
        
          if (0 == strcmp(tmp, "STString")) {arg1=Setting::TypeString; goto done2170;}
        
          if (0 == strcmp(tmp, "STArray")) {arg1=Setting::TypeArray; goto done2170;}
        
          if (0 == strcmp(tmp, "STList")) {arg1=Setting::TypeList; goto done2170;}
        
          if (0 == strcmp(tmp, "STGroup")) {arg1=Setting::TypeGroup; goto done2170;}
         {
        sprintf(staticError, "Unable to convert %s to Setting::Type", tmp);
        scriptError(staticError);
      } 
...
void classdec1348(bool safe, Tcl_Interp* interp) throw() {
  TclConfReg::cppDecCode(safe,interp);
}
 int get1443 (ClientData, Tcl_Interp* interp, int objc, Tcl_Obj*const objv[]) throw() {
      SHIFT;
      #define scriptError(desc) { scriptingErrorMessage=desc; goto error; }
      if (objc != 0) {
        Tcl_SetResult(interp, "Invalid usage of internal glue function get1443", TCL_VOLATILE);
        return TCL_ERROR;
      }
      Tcl_Obj* objout;
