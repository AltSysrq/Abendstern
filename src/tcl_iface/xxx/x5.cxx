 ...
 int set179 (ClientData, Tcl_Interp* interp, int objc, Tcl_Obj*const objv[]) throw() {
      ...
      //Extract value
      {
        ...
        if (strlen(tmp) > 100) { scriptError("Enumeration value too long"); }
          ...
          if (0 == strcmp(tmp, "AGLT14")) {newVal=AGLT14; goto done1605;}
        
          if (0 == strcmp(tmp, "AGLT21")) {newVal=AGLT21; goto done1605;}
        
          if (0 == strcmp(tmp, "AGLT32")) {newVal=AGLT32; goto done1605;}
         {
...
static void cppDecCode(bool safe,Tcl_Interp* interp) throw() {Tcl_CreateObjCommand(interp, "c++ trampoline781", trampoline781, 0, NULL);
...
arg1Init=true;
{
        ...
        if (strlen(tmp) > 100) { scriptError("Enumeration value too long"); }
          ...
          if (0 == strcmp(tmp, "SILRStrict")) {arg2=SquareIcon::Strict; goto done2089;}
        
          if (0 == strcmp(tmp, "SILRLax")) {arg2=SquareIcon::Lax; goto done2089;}
        
          if (0 == strcmp(tmp, "SILRScale")) {arg2=SquareIcon::Scale; goto done2089;}
         {
...
static void cppDecCode(bool safe,Tcl_Interp* interp) throw() {Tcl_CreateObjCommand(interp, "c++ trampoline1153", trampoline1153, 0, NULL);
...
void classdec1152(bool safe, Tcl_Interp* interp) throw() {
