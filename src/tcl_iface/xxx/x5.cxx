...
arg3Init=true;
{int gen1433;
            int err = Tcl_GetBooleanFromObj(interp, objv[4], (int*)&gen1433);
            arg4=gen1433;
            if (err == TCL_ERROR) {
              scriptError(Tcl_GetStringResult(interp));
            }};
...
static void cppDecCode(bool safe,Tcl_Interp* interp) throw() {Tcl_CreateObjCommand(interp, "c++ trampoline597", trampoline597, 0, NULL);
...
void classdec596(bool safe, Tcl_Interp* interp) throw() {
  TclShield::cppDecCode(safe,interp);
}

class TclController : public Controller {
      public:
static int get759 (ClientData, Tcl_Interp* interp, int objc, Tcl_Obj*const objv[]) throw() {
      SHIFT;
      #define scriptError(desc) { scriptingErrorMessage=desc; goto error; }
      if (objc != 1) {
        Tcl_SetResult(interp, "Invalid usage of internal glue function get759", TCL_VOLATILE);
        return TCL_ERROR;
      }
      Tcl_Obj* objout;
      Controller* parent; {
...
static void cppDecCode(bool safe,Tcl_Interp* interp) throw() {Tcl_CreateObjCommand(interp, "c++ get759", get759, 0, NULL);
...
Tcl_CreateObjCommand(interp, "c++ deftramp770", deftramp770, 0, NULL);
...
void classdec758(bool safe, Tcl_Interp* interp) throw() {
...
static int get1140 (ClientData, Tcl_Interp* interp, int objc, Tcl_Obj*const objv[]) throw() {
      SHIFT;
      #define scriptError(desc) { scriptingErrorMessage=desc; goto error; }
      if (objc != 1) {
...
static int set1141 (ClientData, Tcl_Interp* interp, int objc, Tcl_Obj*const objv[]) throw() {
      SHIFT;
      #define scriptError(desc) { scriptingErrorMessage=desc; goto error; }
      if (objc != 1+1) {
        Tcl_SetResult(interp, "Invalid usage of internal glue function set1141", TCL_VOLATILE);
        return TCL_ERROR;
      }
      Tuner* newVal;
      Antenna* parent; {
...
static void cppDecCode(bool safe,Tcl_Interp* interp) throw() {Tcl_CreateObjCommand(interp, "c++ trampoline1138", trampoline1138, 0, NULL);
Tcl_CreateObjCommand(interp, "c++ get1140", get1140, 0, NULL);
Tcl_CreateObjCommand(interp, "c++ set1141", set1141, 0, NULL);
...
void classdec1137(bool safe, Tcl_Interp* interp) throw() {
  TclAntenna::cppDecCode(safe,interp);
}
 int get1157 (ClientData, Tcl_Interp* interp, int objc, Tcl_Obj*const objv[]) throw() {
      SHIFT;
      #define scriptError(desc) { scriptingErrorMessage=desc; goto error; }
      if (objc != 0) {
        Tcl_SetResult(interp, "Invalid usage of internal glue function get1157", TCL_VOLATILE);
        return TCL_ERROR;
      }
      Tcl_Obj* objout;
 ...
 int get1159 (ClientData, Tcl_Interp* interp, int objc, Tcl_Obj*const objv[]) throw() {
      SHIFT;
      #define scriptError(desc) { scriptingErrorMessage=desc; goto error; }
      if (objc != 0) {
        Tcl_SetResult(interp, "Invalid usage of internal glue function get1159", TCL_VOLATILE);
        return TCL_ERROR;
      }
      Tcl_Obj* objout;
 ...
 int set1160 (ClientData, Tcl_Interp* interp, int objc, Tcl_Obj*const objv[]) throw() {
      SHIFT;
      #define scriptError(desc) { scriptingErrorMessage=desc; goto error; }
      if (objc != 0+1) {
        Tcl_SetResult(interp, "Invalid usage of internal glue function set1160", TCL_VOLATILE);
        return TCL_ERROR;
      }
      unsigned newVal;
