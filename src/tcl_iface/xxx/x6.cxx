...
arg3Init=true;
{int gen1598;
            int err = Tcl_GetBooleanFromObj(interp, objv[4], (int*)&gen1598);
            arg4=gen1598;
            if (err == TCL_ERROR) {
              scriptError(Tcl_GetStringResult(interp));
            }};
...
static void cppDecCode(bool safe,Tcl_Interp* interp) throw() {Tcl_CreateObjCommand(interp, "c++ trampoline622", trampoline622, 0, NULL);
...
Tcl_CreateObjCommand(interp, "c++ trampoline634", trampoline634, 0, NULL);
...
void classdec621(bool safe, Tcl_Interp* interp) throw() {
  TclShield::cppDecCode(safe,interp);
}

class TclController : public Controller {
      public:
static int get784 (ClientData, Tcl_Interp* interp, int objc, Tcl_Obj*const objv[]) throw() {
      SHIFT;
      #define scriptError(desc) { scriptingErrorMessage=desc; goto error; }
      if (objc != 1) {
        Tcl_SetResult(interp, "Invalid usage of internal glue function get784", TCL_VOLATILE);
        return TCL_ERROR;
      }
      Tcl_Obj* objout;
      Controller* parent; {
...
static void cppDecCode(bool safe,Tcl_Interp* interp) throw() {Tcl_CreateObjCommand(interp, "c++ get784", get784, 0, NULL);
...
Tcl_CreateObjCommand(interp, "c++ deftramp791", deftramp791, 0, NULL);
Tcl_CreateObjCommand(interp, "c++ trampoline792", trampoline792, 0, NULL);
Tcl_CreateObjCommand(interp, "c++ deftramp793", deftramp793, 0, NULL);
Tcl_CreateObjCommand(interp, "c++ trampoline794", trampoline794, 0, NULL);
Tcl_CreateObjCommand(interp, "c++ deftramp795", deftramp795, 0, NULL);
...
void classdec783(bool safe, Tcl_Interp* interp) throw() {
...
static int set1171 (ClientData, Tcl_Interp* interp, int objc, Tcl_Obj*const objv[]) throw() {
      SHIFT;
      #define scriptError(desc) { scriptingErrorMessage=desc; goto error; }
      if (objc != 1+1) {
        Tcl_SetResult(interp, "Invalid usage of internal glue function set1171", TCL_VOLATILE);
        return TCL_ERROR;
      }
      Tuner* newVal;
      Antenna* parent; {
...
static void cppDecCode(bool safe,Tcl_Interp* interp) throw() {Tcl_CreateObjCommand(interp, "c++ trampoline1168", trampoline1168, 0, NULL);
Tcl_CreateObjCommand(interp, "c++ get1170", get1170, 0, NULL);
Tcl_CreateObjCommand(interp, "c++ set1171", set1171, 0, NULL);
...
void classdec1167(bool safe, Tcl_Interp* interp) throw() {
 ...
 int get1187 (ClientData, Tcl_Interp* interp, int objc, Tcl_Obj*const objv[]) throw() {
      SHIFT;
      #define scriptError(desc) { scriptingErrorMessage=desc; goto error; }
      if (objc != 0) {
        Tcl_SetResult(interp, "Invalid usage of internal glue function get1187", TCL_VOLATILE);
        return TCL_ERROR;
      }
      Tcl_Obj* objout;
 ...
 int get1189 (ClientData, Tcl_Interp* interp, int objc, Tcl_Obj*const objv[]) throw() {
      SHIFT;
      #define scriptError(desc) { scriptingErrorMessage=desc; goto error; }
      if (objc != 0) {
 ...
 int set1190 (ClientData, Tcl_Interp* interp, int objc, Tcl_Obj*const objv[]) throw() {
      SHIFT;
      #define scriptError(desc) { scriptingErrorMessage=desc; goto error; }
      if (objc != 0+1) {
        Tcl_SetResult(interp, "Invalid usage of internal glue function set1190", TCL_VOLATILE);
        return TCL_ERROR;
      }
      unsigned newVal;
