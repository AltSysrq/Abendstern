...
#include "src/net/crypto.hxx"
 ...
 int set227 (ClientData, Tcl_Interp* interp, int objc, Tcl_Obj*const objv[]) throw() {
      ...
      {int gen1609;
         ...
         Tcl_UniChar* tuc = Tcl_GetUnicodeFromObj(objv[0], &gen1609);
         const char* gen1607 = Tcl_UniCharToUtfDString(tuc, gen1609, &dstr);
         char* gen1608 = new char[gen1609+1];
         strcpy(gen1608, gen1607);
         newVal=gen1608;}
 ...
 int get229 (ClientData, Tcl_Interp* interp, int objc, Tcl_Obj*const objv[]) throw() {
      SHIFT;
      #define scriptError(desc) { scriptingErrorMessage=desc; goto error; }
      if (objc != 0) {
        Tcl_SetResult(interp, "Invalid usage of internal glue function get229", TCL_VOLATILE);
        return TCL_ERROR;
      }
      Tcl_Obj* objout;
 ...
 int set230 (ClientData, Tcl_Interp* interp, int objc, Tcl_Obj*const objv[]) throw() {
      SHIFT;
      #define scriptError(desc) { scriptingErrorMessage=desc; goto error; }
      if (objc != 0+1) {
        Tcl_SetResult(interp, "Invalid usage of internal glue function set230", TCL_VOLATILE);
        return TCL_ERROR;
      }
      int newVal;
 ...
 int get232 (ClientData, Tcl_Interp* interp, int objc, Tcl_Obj*const objv[]) throw() {
      SHIFT;
      #define scriptError(desc) { scriptingErrorMessage=desc; goto error; }
      if (objc != 0) {
 ...
 int set233 (ClientData, Tcl_Interp* interp, int objc, Tcl_Obj*const objv[]) throw() {
      SHIFT;
      #define scriptError(desc) { scriptingErrorMessage=desc; goto error; }
      if (objc != 0+1) {
        Tcl_SetResult(interp, "Invalid usage of internal glue function set233", TCL_VOLATILE);
        return TCL_ERROR;
      }
      ...
      //Extract value
      {
        ...
        if (strlen(tmp) > 100) { scriptError("Enumeration value too long"); }
          ...
          if (0 == strcmp(tmp, "TSMStandardTeam")) {newVal=test_state::StandardTeam; goto done1610;}
        
          if (0 == strcmp(tmp, "TSMHomogeneousTeam")) {newVal=test_state::HomogeneousTeam; goto done1610;}
        
          if (0 == strcmp(tmp, "TSMHeterogeneousTeam")) {newVal=test_state::HeterogeneousTeam; goto done1610;}
        
          if (0 == strcmp(tmp, "TSMFreeForAll")) {newVal=test_state::FreeForAll; goto done1610;}
        
          if (0 == strcmp(tmp, "TSMLastManStanding")) {newVal=test_state::LastManStanding; goto done1610;}
        
          if (0 == strcmp(tmp, "TSMManVsWorld")) {newVal=test_state::ManVsWorld; goto done1610;}
         {
...
done1610:;}
 ...
 int get235 (ClientData, Tcl_Interp* interp, int objc, Tcl_Obj*const objv[]) throw() {
      SHIFT;
      #define scriptError(desc) { scriptingErrorMessage=desc; goto error; }
      if (objc != 0) {
        Tcl_SetResult(interp, "Invalid usage of internal glue function get235", TCL_VOLATILE);
        return TCL_ERROR;
      }
      Tcl_Obj* objout;
 ...
 int set236 (ClientData, Tcl_Interp* interp, int objc, Tcl_Obj*const objv[]) throw() {
      SHIFT;
      #define scriptError(desc) { scriptingErrorMessage=desc; goto error; }
      if (objc != 0+1) {
        Tcl_SetResult(interp, "Invalid usage of internal glue function set236", TCL_VOLATILE);
        return TCL_ERROR;
      }
      int newVal;
...
arg1Init=true;
{
        ...
        if (strlen(tmp) > 100) { scriptError("Enumeration value too long"); }
          ...
          if (0 == strcmp(tmp, "TSBStarField")) {arg2=test_state::StarField; goto done1611;}
        
          if (0 == strcmp(tmp, "TSBPlanet")) {arg2=test_state::Planet; goto done1611;}
        
          if (0 == strcmp(tmp, "TSBNebula")) {arg2=test_state::Nebula; goto done1611;}
         {
...
static void cppDecCode(bool safe,Tcl_Interp* interp) throw() {Tcl_CreateObjCommand(interp, "c++ trampoline239", trampoline239, 0, NULL);
Tcl_CreateObjCommand(interp, "c++ trampoline241", trampoline241, 0, NULL);
Tcl_CreateObjCommand(interp, "c++ trampoline243", trampoline243, 0, NULL);
...
void classdec238(bool safe, Tcl_Interp* interp) throw() {
...
returnValueTcl = Tcl_GetObjResult(interp);
        {int gen1854;
            int err = Tcl_GetBooleanFromObj(interp, returnValueTcl, (int*)&gen1854);
            returnValue=gen1854;
            if (err == TCL_ERROR) {
              scriptError(Tcl_GetStringResult(interp));
            }}
...
static void cppDecCode(bool safe,Tcl_Interp* interp) throw() {Tcl_CreateObjCommand(interp, "c++ trampoline655", trampoline655, 0, NULL);
Tcl_CreateObjCommand(interp, "c++ trampoline657", trampoline657, 0, NULL);
Tcl_CreateObjCommand(interp, "c++ deftramp658", deftramp658, 0, NULL);
Tcl_CreateObjCommand(interp, "c++ trampoline659", trampoline659, 0, NULL);
Tcl_CreateObjCommand(interp, "c++ trampoline661", trampoline661, 0, NULL);
Tcl_CreateObjCommand(interp, "c++ trampoline663", trampoline663, 0, NULL);
Tcl_CreateObjCommand(interp, "c++ trampoline665", trampoline665, 0, NULL);
...
void classdec654(bool safe, Tcl_Interp* interp) throw() {
...
void classdec1193(bool safe, Tcl_Interp* interp) throw() {
