...
class TclBlast : public Blast {
      public:
static int get343 (ClientData, Tcl_Interp* interp, int objc, Tcl_Obj*const objv[]) throw() {
      SHIFT;
      #define scriptError(desc) { scriptingErrorMessage=desc; goto error; }
      if (objc != 1) {
        Tcl_SetResult(interp, "Invalid usage of internal glue function get343", TCL_VOLATILE);
        return TCL_ERROR;
      }
      Tcl_Obj* objout;
      Blast* parent; {
...
arg7Init=true;
{int gen1529;
            int err = Tcl_GetBooleanFromObj(interp, objv[8], (int*)&gen1529);
            arg8=gen1529;
            if (err == TCL_ERROR) {
              scriptError(Tcl_GetStringResult(interp));
            }};
...
arg7Init=true;
{int gen1531;
            int err = Tcl_GetBooleanFromObj(interp, objv[8], (int*)&gen1531);
            arg8=gen1531;
            if (err == TCL_ERROR) {
              scriptError(Tcl_GetStringResult(interp));
            }};
...
arg7Init=true;
{int gen1533;
            int err = Tcl_GetBooleanFromObj(interp, objv[8], (int*)&gen1533);
            arg8=gen1533;
            if (err == TCL_ERROR) {
              scriptError(Tcl_GetStringResult(interp));
            }};
...
arg9Init=true;
{int gen1534;
            int err = Tcl_GetBooleanFromObj(interp, objv[10], (int*)&gen1534);
            arg10=gen1534;
            if (err == TCL_ERROR) {
              scriptError(Tcl_GetStringResult(interp));
            }};
...
arg7Init=true;
{int gen1536;
            int err = Tcl_GetBooleanFromObj(interp, objv[8], (int*)&gen1536);
            arg8=gen1536;
            if (err == TCL_ERROR) {
              scriptError(Tcl_GetStringResult(interp));
            }};
...
arg9Init=true;
{int gen1537;
            int err = Tcl_GetBooleanFromObj(interp, objv[10], (int*)&gen1537);
            arg10=gen1537;
            if (err == TCL_ERROR) {
              scriptError(Tcl_GetStringResult(interp));
            }};
arg10Init=true;
{int gen1538;
            int err = Tcl_GetBooleanFromObj(interp, objv[11], (int*)&gen1538);
            arg11=gen1538;
            if (err == TCL_ERROR) {
              scriptError(Tcl_GetStringResult(interp));
            }};
...
arg7Init=true;
{int gen1540;
            int err = Tcl_GetBooleanFromObj(interp, objv[8], (int*)&gen1540);
            arg8=gen1540;
            if (err == TCL_ERROR) {
              scriptError(Tcl_GetStringResult(interp));
            }};
...
arg9Init=true;
{int gen1541;
            int err = Tcl_GetBooleanFromObj(interp, objv[10], (int*)&gen1541);
            arg10=gen1541;
            if (err == TCL_ERROR) {
              scriptError(Tcl_GetStringResult(interp));
            }};
arg10Init=true;
{int gen1542;
            int err = Tcl_GetBooleanFromObj(interp, objv[11], (int*)&gen1542);
            arg11=gen1542;
            if (err == TCL_ERROR) {
              scriptError(Tcl_GetStringResult(interp));
            }};
arg11Init=true;
{int gen1543;
            int err = Tcl_GetBooleanFromObj(interp, objv[12], (int*)&gen1543);
            arg12=gen1543;
            if (err == TCL_ERROR) {
              scriptError(Tcl_GetStringResult(interp));
            }};
...
{int gen1545;
            int err = Tcl_GetBooleanFromObj(interp, objv[3], (int*)&gen1545);
            arg3=gen1545;
            if (err == TCL_ERROR) {
              scriptError(Tcl_GetStringResult(interp));
            }};
...
static void cppDecCode(bool safe,Tcl_Interp* interp) throw() {Tcl_CreateObjCommand(interp, "c++ get343", get343, 0, NULL);
...
void classdec342(bool safe, Tcl_Interp* interp) throw() {
...
arg2Init=true;
{int gen1823;
            int err = Tcl_GetBooleanFromObj(interp, objv[3], (int*)&gen1823);
            arg3=gen1823;
            if (err == TCL_ERROR) {
              scriptError(Tcl_GetStringResult(interp));
            }};
...
static void cppDecCode(bool safe,Tcl_Interp* interp) throw() {Tcl_CreateObjCommand(interp, "c++ trampoline838", trampoline838, 0, NULL);
...
Tcl_CreateObjCommand(interp, "c++ trampoline846", trampoline846, 0, NULL);
...
void classdec837(bool safe, Tcl_Interp* interp) throw() {
...
arg2Init=true;
{int gen1937;
            int err = Tcl_GetBooleanFromObj(interp, objv[3], (int*)&gen1937);
            arg3=gen1937;
            if (err == TCL_ERROR) {
              scriptError(Tcl_GetStringResult(interp));
            }};
...
arg5Init=true;
{int gen1938;
            int err = Tcl_GetBooleanFromObj(interp, objv[6], (int*)&gen1938);
            arg6=gen1938;
            if (err == TCL_ERROR) {
              scriptError(Tcl_GetStringResult(interp));
            }};
...
static void cppDecCode(bool safe,Tcl_Interp* interp) throw() {Tcl_CreateObjCommand(interp, "c++ trampoline1200", trampoline1200, 0, NULL);
